...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 16, 2017 at 05:37 AM
...
CREATE TABLE `tbl_comments` (
  `mov_id` smallint(4) UNSIGNED NOT NULL,
...
INSERT INTO `tbl_comments` (`mov_id`, `movies_title`, `movie_comment`) VALUES
(1, 'Taken', 'Taken 2 took it home'),
(2, 'Tremors', 'Tremors is ok'),
(3, 'Iron', 'Iron Man is my hero');
...
CREATE TABLE `tbl_movies` (
  ...
  `movies_genre` varchar(25) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_movies` (`movies_id`, `movies_thumb`, `movies_fimg`, `movies_bimg`, `movies_title`, `movies_year`, `movies_storyline`, `movies_runtime`, `movies_trailer`, `movies_price`, `movies_genre`) VALUES
(1, 'TH_Tremors.jpg', 'Tremors.jpg', 'nobImg.jpg', 'Tremors', '1990', 'A small town gradually becomes aware of a strange creature which picks off people one by one. But what is this creature, and where is it? At the same time, a seismologist is working in the area, she detects tremors. The creature lives underground, and can pop up without warning. Trapped in their town, the town-folk have no escape.', '96 min', 'Tremors_Official_Trailer.mp4', '26.99', 'Horror'),
(2, 'TH_DespicableMe.jpg', 'DespicableMe.jpg', 'nobImg.jpg', 'Despicable Me', '2009', 'In a happy suburban neighborhood surrounded by white picket fences with flowering rose bushes, sits a black house with a dead lawn. Unbeknownst to the neighbors, hidden beneath this home is a vast secret hideout. Surrounded by a small army of minions, we discover Gru, planning the biggest heist in the history of the world. He is going to steal the moon. (Yes, the moon!) Gru delights in all things wicked. Armed with his arsenal of shrink rays, freeze rays, and battle-ready vehicles for land and air, he vanquishes all who stand in his way. Until the day he encounters the immense will of three little orphaned girls who look at him and see something that no one else has ever seen: a potential Dad. The world\'s greatest villain has just met his greatest challenge: three little girls named Margo, Edith and Agnes. ', '95 min', 'Despicable_Me_Trailer.mp4', '26.99', 'Family'),
(3, 'th_Wall_E.jpg', 'Wall_E.jpg', 'nobImg.jpg', 'Wall E', '2008', 'In a distant, but not so unrealistic, future where mankind has abandoned earth because it has become covered with trash from products sold by the powerful multi-national Buy N Large corporation, WALL-E, a garbage collecting robot has been left to clean up the mess. Mesmerized with trinkets of Earth\'s history and show tunes, WALL-E is alone on Earth except for a sprightly pet cockroach. One day, EVE, a sleek (and dangerous) reconnaissance robot, is sent to Earth to find proof that life is once again sustainable. WALL-E falls in love with EVE. WALL-E rescues EVE from a dust storm and shows her a living plant he found amongst the rubble. Consistent with her "directive", EVE takes the plant and automatically enters a deactivated state except for a blinking green beacon. WALL-E, doesn\'t understand what has happened to his new friend, but, true to his love, he protects her from wind...', '98 min', 'WallE_Trailer.mp4', '26.99', 'Family'),
(4, 'TH_HorribleBosses.jpg', 'HorribleBosses.jpg', 'nobImg.jpg', 'Horrible Bosses', '2011', 'Nick hates his boss, mostly because he\'s expected to work from before sunrise to after sunset and his boss, Mr. Harken, calls him out for being a minute late and blackmails him so he can\'t quit. Dale hates his boss, Dr. Julia Harris, because she makes unwelcome sexual advances when he\'s about to get married. But Dale is on that pesky list of child offenders so he can\'t quit. Kurt actually likes his job and his boss, well, up until his boss dies and the boss\'s coked-out, psychopathic son takes over. But who would be crazy enough to quit their jobs in such poor economic times? Instead Nick, Dale and Kurt drunkenly and hypothetically discuss how to kill their bosses, and before they know it, they\'ve hired a murder consultant to help them pull off the three deeds.', '98 min', 'Horrible_Bosses_Trailer.mp4', '22.99', 'Comedy'),
(5, 'TH_TheHangover.jpg', 'TheHangover.jpg', 'nobImg.jpg', 'The Hangover', '2009', 'Angelenos Doug Billings and Tracy Garner are about to get married. Two days before the wedding, the four men in the wedding party - Doug, Doug\'s two best buddies Phil Wenneck and Stu Price, and Tracy\'s brother Alan Garner - hop into Tracy\'s father\'s beloved Mercedes convertible for a 24-hour stag party to Las Vegas. Phil, a married high school teacher, has the same maturity level as his students when he\'s with his pals. Stu, a dentist, is worried about everything, especially what his controlling girlfriend Melissa thinks. Because she disapproves of traditional male bonding rituals, Stu has to lie to her about the stag, he telling her that they are going on a wine tasting tour in the Napa Valley. Regardless, he intends on eventually marrying her, against the advice and wishes of his friends. And Alan seems to be unaware of what are considered the social graces of the western world...', '100 min', 'The_Hangover_Trailer.mp4', '22.99', 'Comedy'),
(6, 'TH_BlackHawkDown.jpg', 'BlackHawkDown.jpg', 'nobImg.jpg', 'Black Hawk Down', '2001', 'Action/war drama based on the best-selling book detailing a near-disastrous mission in Somalia on October 3, 1993. On this date nearly 100 U.S. Army Rangers, commanded by Capt. Mike Steele, were dropped by helicopter deep into the capital city of Mogadishu to capture two top lieutenants of a Somali warlord. This lead to a large and drawn-out firefight between the Rangers and hundreds of Somali gunmen, leading to the destruction of two U.S. Black Hawk helicopters. This film focuses on the heroic efforts of various Rangers to get to the downed black hawks, centering on Sgt. Eversmann, leading the Ranger unit Chalk Four to the first black hawk crash site, Warrant Officer Durant who was captured after being the only survivor of the second black hawk crash, as well as many others who were involved. ', '144 min', 'Black_Hawk_Down_Trailer.mp4', '22.99', 'Action'),
(7, 'TH_IronMan2.jpg', 'IronMan2.jpg', 'nobImg.jpg', 'Iron Man 2', '2010', 'With the world now aware of his dual life as the armored superhero Iron Man, billionaire inventor Tony Stark faces pressure from the government, the press, and the public to share his technology with the military. Unwilling to let go of his invention, Stark, along with Pepper Potts, and James "Rhodey" Rhodes at his side, must forge new alliances - and confront powerful enemies.', '124 min', 'Iron_Man2_Trailer.mp4', '26.99', 'Action'),
(8, 'TH_Taken2.jpg', 'Taken2.jpg', 'nobImg.jpg', 'Taken 2', '2012', 'Bryan Mills, the retired CIA agent, stopped at nothing to save his daughter Kim from Albanian kidnappers. The father of one of the kidnappers has sworn revenge and takes Bryan and his wife hostage during their family vacation in Istanbul. Bryan enlists his daughter to help them escape.', '92 min', 'TAKEN_2_Trailer.mp4', '26.99', 'Action'),
(9, 'TH_TransformersDOTM.jpg', 'TransformersDOTM.jpg', 'nobImg.jpg', 'Transformers Dark Side Of The Moon', '2011', 'Autobots Bumblebee, Ratchet, Ironhide, Mirage (aka Dino), Wheeljack (aka Que) and Sideswipe led by Optimus Prime, are back in action taking on the evil Decepticons, who are eager to avenge their recent defeat. The Autobots and Decepticons become involved in a perilous space race between the United States and Russia, to reach a hidden Cybertronian spacecraft on the moon and learn its secrets, and once again Sam Witwicky has to come to the aid of his robot friends. The new villain Shockwave is on the scene while the Autobots and Decepticons continue to battle it out on Earth.', '154 min', 'Transformers_Trailer.mp4', '26.99', 'Action'),
(10, 'TH_UsualSuspects.jpg', 'UsualSuspects.jpg', 'nobImg.jpg', 'The Usual Suspects', '1995', 'Following a truck hijack in New York, five conmen are arrested and brought together for questioning. As none of them is guilty, they plan a revenge operation against the police. The operation goes well, but then the influence of a legendary mastermind criminal called Keyser Söze is felt. It becomes clear that each one of them has wronged Söze at some point and must pay back now. The payback job leaves 27 men dead in a boat explosion, but the real question arises now: Who actually is Keyser Soze? ', '106 min', 'The_Usual_Suspects_Trailer.mp4', '22.99', 'Action');
...
(3, 'Gabriel', 'More', 'gmoreira', 'password', '1', '::1');
...
--
ALTER TABLE `tbl_comments`
  MODIFY `mov_id` smallint(4) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
